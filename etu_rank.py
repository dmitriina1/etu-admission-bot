...
LISTS = {
    "Список 1 — Электроника, фотоника, приборостроение и связь": (
        "019ee53c-e6ac-7791-af10-3a9842257c11"
    ),
    "Список 2": (
        "019ee53c-e6ac-7971-af10-3a9844da95ee"
    ),
}
...
MODES = (
    ...
    ("Только с согласием", ["has_agreement"]),
